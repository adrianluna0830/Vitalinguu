...
List<RouteBase> get $appRoutes => [$languageSelectionRoute, $settingsRoute];

RouteBase get $languageSelectionRoute => GoRouteData.$route(
...
mixin $LanguageSelectionRoute on GoRouteData {
  ...
  @override
  String get location => GoRouteData.$location('/language-selection');
